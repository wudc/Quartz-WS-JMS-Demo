package com.cjet.quartz.demo.service;
...
import com.cjet.payments.demo.job.PaymentJob;
...
public class SchedulerService implements InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		scheduleJob(PaymentJob.class, PaymentJob.class.getSimpleName(), "Payments", "/10 * * * * ?");
	}
